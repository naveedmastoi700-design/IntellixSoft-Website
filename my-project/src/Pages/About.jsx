        ...
        <>
            ...
            <section id="technology" className="py-16 bg-white">
                <div className="container mx-auto flex flex-col xl:flex-row items-center gap-12 px-6 lg:px-12">
                    ...
                    <div className="relative xl:max-w-1/2 max-w-[600px] h-[450px] border-4 border-[#56A49E] rounded-xl overflow-hidden order-1 xl:order-2">
                        <img
                            src={group}
                            alt="group"
            ...
            <section id="request" className="relative flex justify-center px-4 sm:px-6 lg:px-12 py-20">
                ...
                <div
                    className="relative w-full max-w-[1430px] rounded-lg h-[400px] bg-cover bg-center"
                ...
                <div className="container mx-auto flex flex-col lg:flex-row items-center gap-10 px-4">
                    ...
                    <div className="w-full lg:w-1/2 flex justify-center">
                        <img
                            src={Issue}
                            alt="Issue"
                            className="w-full max-w-md sm:max-w-lg lg:max-w-xl h-auto aspect-square object-cover rounded-lg border-4 border-[#145B55]"
                        />
                    </div>
