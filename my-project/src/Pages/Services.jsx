...
const ServicesHero = () => {
    return (
        <>
            <section className="relative w-full h-[430px] flex items-center justify-center overflow-hidden">
                {/* Background Image */}
                <img
                    src={service}
                ...
                <div className="relative z-10 text-center px-4 max-w-[900px] mx-auto">
                    <h1 className="text-white text-[42px] md:text-[52px] font-extrabold mb-2">
                        Services
                    </h1>

                    <h2 className="text-white text-[20px] md:text-[24px] font-bold mb-5">
                        We provide a wide range of Services
                    </h2>

                    <p className="text-white text-[15px] md:text-[17px] leading-7 max-w-[750px] mx-auto">
