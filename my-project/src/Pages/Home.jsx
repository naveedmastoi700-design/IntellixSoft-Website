    ...
    return (
        <>
            ...
            <section id="services" className="bg-white py-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-9 p-10 mt-4">
                    {serviceCards.map((service, index) => (
                        <div
                            key={index}
                            className={`bg-white p-[35px] rounded-[28px] relative overflow-hidden transition-all duration-500 border ${service.border} hover:-translate-y-3 ${service.shadow}`}
                        >
                            <div
            ...
            {/* Request Section */}
            <section id="request" className="relative flex justify-center px-4">
                <div
                    className="relative w-full max-w-[1340px] min-h-[400px] md:min-h-[500px] flex items-center justify-center rounded-[20px] overflow-hidden bg-cover bg-center"
                    style={{
                ...
                >
                    ...
                    <div className="relative z-10 w-full max-w-3xl flex flex-col items-center justify-center gap-6 text-center px-6">
                        <h1 className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold leading-snug">
                            Request a Customized
                            <br className="hidden sm:block" />
                            Solution for Your Business!
                        </h1>

                        <p className="text-base sm:text-lg md:text-xl font-normal text-[#EDF2F4] leading-8">
            ...
            <section className="w-full py-24 px-6 bg-[#f4f7fb] overflow-hidden">
                ...
                <div className="max-w-[1450px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
